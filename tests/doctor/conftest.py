...
def healthy_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(doctor, "which", _which_all_present)
    monkeypatch.setattr(doctor, "_probe_cli_launch", lambda binary: None)  # fake successful exec
    ...
    _real_worktree_check = doctor._check_worktree_root
